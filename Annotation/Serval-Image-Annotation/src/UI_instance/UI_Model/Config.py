...
class Ui_config(object):
    def setupUi(self, config):
        ...
        self.btnDelPath = QtWidgets.QPushButton(config)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.btnDelPath.sizePolicy().hasHeightForWidth())
        self.btnDelPath.setSizePolicy(sizePolicy)
        self.btnDelPath.setObjectName("btnDelPath")
        self.gridLayout.addWidget(self.btnDelPath, 2, 1, 1, 1)
